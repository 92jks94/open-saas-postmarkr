...
// PUBLIC API
export const getMailAddressesByUser: AuthenticatedOperationFor<GetMailAddressesByUser_ext> =
  createAuthenticatedOperation(
    getMailAddressesByUser_ext,
    {
      User: prisma.user,
...
// PUBLIC API
export const getMailPieces: AuthenticatedOperationFor<GetMailPieces_ext> =
  createAuthenticatedOperation(
    getMailPieces_ext,
    {
...
// PUBLIC API
export const getMailPiece: AuthenticatedOperationFor<GetMailPiece_ext> =
  createAuthenticatedOperation(
    getMailPiece_ext,
    {
      MailPiece: prisma.mailPiece,
