...
// PUBLIC API
export const getMailAddressesByUser: QueryFor<GetMailAddressesByUser_ext> = createQuery<GetMailAddressesByUser_ext>(
  'operations/get-mail-addresses-by-user',
  ['User', 'MailAddress'],
)
...
// PUBLIC API
export const getMailPieces: QueryFor<GetMailPieces_ext> = createQuery<GetMailPieces_ext>(
  'operations/get-mail-pieces',
  ['MailPiece', 'MailAddress', 'File', 'MailPieceStatusHistory'],
)

// PUBLIC API
export const getMailPiece: QueryFor<GetMailPiece_ext> = createQuery<GetMailPiece_ext>(
  'operations/get-mail-piece',
  ['MailPiece', 'MailAddress', 'File', 'MailPieceStatusHistory'],
)
