...
export declare const routes: {
    ...
    readonly AddressManagementRoute: {
        readonly to: "/addresses";
        readonly build: (options?: OptionalRouteOptions) => string;
    };
    readonly AdminRoute: {
        readonly to: "/admin";
    ...
    readonly MailCreationRoute: {
        readonly to: "/mail/create";
        readonly build: (options?: OptionalRouteOptions) => string;
    };
    readonly MailHistoryRoute: {
        readonly to: "/mail/history";
        readonly build: (options?: OptionalRouteOptions) => string;
    };
    readonly MailDetailsRoute: {
        readonly to: "/mail/:id";
        readonly build: (options: OptionalRouteOptions & {
            params: {
                "id": ParamValue;
