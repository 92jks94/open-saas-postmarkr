...
export const routes = {
    ...
    AddressManagementRoute: {
        to: "/addresses",
        build: (options) => interpolatePath("/addresses", undefined, options?.search, options?.hash),
    },
    AdminRoute: {
        to: "/admin",
    ...
    MailCreationRoute: {
        to: "/mail/create",
        build: (options) => interpolatePath("/mail/create", undefined, options?.search, options?.hash),
    },
    MailHistoryRoute: {
        to: "/mail/history",
        build: (options) => interpolatePath("/mail/history", undefined, options?.search, options?.hash),
    },
    MailDetailsRoute: {
        to: "/mail/:id",
        build: (options) => interpolatePath("/mail/:id", options.params, options?.search, options?.hash),
    },
    AdminMessagesRoute: {
        to: "/admin/messages",
