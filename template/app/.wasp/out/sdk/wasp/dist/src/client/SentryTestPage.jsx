            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  <button onClick={triggerClientError} className="w-full bg-red-500 hover:bg-red-600 text-white font-medium py-2 px-4 rounded transition-colors">
                    Trigger Client Error
                  </button>
                  
                  <button onClick={triggerClientMessage} className="w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded transition-colors">
                    Send Test Message
                  </button>
                  
                  <button onClick={triggerClientBreadcrumb} className="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded transition-colors">
                    Add Breadcrumb
                  </button>
                </div>
              </div>
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  <button onClick={testServerError} className="w-full bg-purple-500 hover:bg-purple-600 text-white font-medium py-2 px-4 rounded transition-colors">
                    Test Server Error
                  </button>
...
//# sourceMappingURL=SentryTestPage.jsx.map