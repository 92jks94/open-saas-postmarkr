    ...
    return (<div className={className}>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.mailType} onValueChange={(value) => setFormData(prev => ({ ...prev, mailType: value }))}>
                <SelectTrigger>
                  <SelectValue placeholder="Select mail type"/>
                </SelectTrigger>
                <SelectContent>
                  {mailTypeOptions.map(option => (<SelectItem key={option.value} value={option.value}>
                      <div>
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.mailClass} onValueChange={(value) => setFormData(prev => ({ ...prev, mailClass: value }))}>
                <SelectTrigger>
                  <SelectValue placeholder="Select mail class"/>
                </SelectTrigger>
                <SelectContent>
                  {mailClassOptions.map(option => (<SelectItem key={option.value} value={option.value}>
                      <div>
                        <div className="font-medium">{option.label}</div>
                        <div className="text-xs text-gray-500">{option.description}</div>
                      </div>
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.mailSize} onValueChange={(value) => setFormData(prev => ({ ...prev, mailSize: value }))}>
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Textarea id="description" placeholder="Brief description of this mail piece..." value={formData.description} onChange={(e) => setFormData(prev => ({ ...prev, description: e.target.value }))} maxLength={500} rows={3}/>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <AddressSelector selectedAddressId={formData.senderAddressId} onAddressSelect={(addressId) => setFormData(prev => ({ ...prev, senderAddressId: addressId }))} addressType="sender"/>
          
          <AddressSelector selectedAddressId={formData.recipientAddressId} onAddressSelect={(addressId) => setFormData(prev => ({ ...prev, recipientAddressId: addressId }))} addressType="recipient"/>
        </div>

        {/* File Selection */}
        <FileSelector selectedFileId={formData.fileId} onFileSelect={(fileId) => setFormData(prev => ({ ...prev, fileId }))} mailType={formData.mailType} mailSize={formData.mailSize}/>
        ...
        <div className="flex justify-end">
          <Button type="submit" disabled={!isFormValid || isSubmitting} className="min-w-[200px]">
            {isSubmitting ? (<>
...
//# sourceMappingURL=MailCreationForm.jsx.map