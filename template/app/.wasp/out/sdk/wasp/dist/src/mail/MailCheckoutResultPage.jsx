 ...
 */
const MailCheckoutResultPage = () => {
    const [searchParams] = useSearchParams();
    const navigate = useNavigate();
    const [mailPiece, setMailPiece] = useState(null);
          ...
          <Card>
            <CardContent className="py-12">
              <div className="text-center">
                ...
                {mailPiece && (<div className="bg-gray-50 rounded-lg p-6 mb-8 text-left">
...
//# sourceMappingURL=MailCheckoutResultPage.jsx.map