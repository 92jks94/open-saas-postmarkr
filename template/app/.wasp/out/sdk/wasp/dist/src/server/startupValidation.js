import { validateEnvironmentOnStartup, isProduction } from './envValidation';
/**
 ...
 */
function validateSendGridConfiguration() {
 ...
 */
function validateLobConfiguration() {
 ...
 */
function logServiceConfiguration() {
    const services = [
