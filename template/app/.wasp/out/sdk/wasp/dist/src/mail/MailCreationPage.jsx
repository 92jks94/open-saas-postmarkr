...
const MailCreationPage = () => {
    ...
    const [createdMailPieceId, setCreatedMailPieceId] = useState(null);
    const handleSuccess = (mailPieceId) => {
    ...
    return (<div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <Button variant="ghost" onClick={() => navigate('/mail/history')} className="mb-4">
...
//# sourceMappingURL=MailCreationPage.jsx.map