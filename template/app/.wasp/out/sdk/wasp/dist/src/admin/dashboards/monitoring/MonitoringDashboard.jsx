...
import { RefreshCw, AlertTriangle, CheckCircle, Clock, Server, Database, BarChart3 } from 'lucide-react';
export default function MonitoringDashboard({ user }) {
    ...
    return (<DefaultLayout user={user}>
      <div className="space-y-6">
        ...
        {systemMetrics && (<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        {healthStatus && (<Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {Object.entries(healthStatus.services).map(([service, status]) => (<div key={service} className="flex items-center justify-between p-3 border rounded-lg">
...
//# sourceMappingURL=MonitoringDashboard.jsx.map