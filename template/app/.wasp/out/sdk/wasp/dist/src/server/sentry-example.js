...
export async function exampleOperationWithSentry(args, context) {
    try {
...
export const wrappedOperation = withSentryErrorHandling(async (args, context) => {
...
async function someBusinessLogic(args) {
...
*/
//# sourceMappingURL=sentry-example.js.map