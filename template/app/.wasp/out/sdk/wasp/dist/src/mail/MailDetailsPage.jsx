...
import { ArrowLeft, CheckCircle, XCircle, AlertCircle, Package, Mail, Clock, MapPin, User, FileText, CreditCard, RefreshCw, Download, Edit, Trash2, MoreHorizontal, ExternalLink } from 'lucide-react';
...
const MailDetailsPage = () => {
    ...
    const { data: mailPiece, isLoading, error, refetch } = useQuery(getMailPiece, { id: id });
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              <Button variant="ghost" onClick={() => navigate('/mail/history')}>
            ...
            <div className="flex items-center space-x-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  {mailPiece.file && (<DropdownMenuItem>
                      <Download className="h-4 w-4 mr-2"/>
                      Download File
                    </DropdownMenuItem>)}
                  {mailPiece.lobId && (<DropdownMenuItem>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  {mailPiece.lobTrackingNumber && (<div className="bg-blue-50 p-3 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  {mailPiece.senderAddress ? (<div className="space-y-2">
                      ...
                      {mailPiece.senderAddress.addressLine2 && (<p className="text-sm text-gray-600">{mailPiece.senderAddress.addressLine2}</p>)}
                      <p className="text-sm text-gray-600">
                    ...
                    </div>) : (<p className="text-sm text-gray-500">No sender address</p>)}
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  {mailPiece.recipientAddress ? (<div className="space-y-2">
                      ...
                      {mailPiece.recipientAddress.addressLine2 && (<p className="text-sm text-gray-600">{mailPiece.recipientAddress.addressLine2}</p>)}
                      <p className="text-sm text-gray-600">
                    ...
                    </div>) : (<p className="text-sm text-gray-500">No recipient address</p>)}
                </CardContent>
              </Card>
            </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  {mailPiece.paymentIntentId && (<div className="flex justify-between">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {mailPiece.statusHistory && mailPiece.statusHistory.length > 0 ? (<div className="space-y-3">
                      {mailPiece.statusHistory.map((history, index) => (<div key={index} className="flex items-start space-x-3">
                    ...
                    </div>) : (<p className="text-sm text-gray-500">No status history available</p>)}
                </div>
              </CardContent>
            </Card>

            {/* Lob Integration */}
            {mailPiece.lobId && (<Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    {mailPiece.lobTrackingNumber && (<div className="flex justify-between">
