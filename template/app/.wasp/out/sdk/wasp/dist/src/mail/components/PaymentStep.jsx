...
import { CreditCard, AlertTriangle, Loader2, DollarSign, Mail, MapPin, FileText } from 'lucide-react';
/**
 * Payment form component using existing Wasp operations
 */
const PaymentForm = ({ mailPiece, onPaymentSuccess, onPaymentCancel }) => {
    ...
    return (<div className="space-y-6">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    {mailPiece.senderAddress.addressLine2 && (<span>, {mailPiece.senderAddress.addressLine2}</span>)}
                  </p>
                  <p className="text-sm text-gray-600">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    {mailPiece.recipientAddress.addressLine2 && (<span>, {mailPiece.recipientAddress.addressLine2}</span>)}
                  </p>
                  <p className="text-sm text-gray-600">
      ...
      <Card>
        ...
        <CardContent>
          {isLoadingCost ? (<div className="flex items-center gap-2">
              <Loader2 className="h-4 w-4 animate-spin"/>
              <span>Calculating cost...</span>
            </div>) : cost !== null ? (<div className="space-y-2">
            ...
            </div>) : (<div className="text-red-600 text-sm">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3">
              <Button type="submit" disabled={isProcessing || isLoadingCost || cost === null} className="flex-1">
                {isProcessing ? (<>
 ...
 */
const PaymentStep = ({ mailPiece, onPaymentSuccess, onPaymentCancel, className = '' }) => {
    return (<div className={className}>
      <PaymentForm mailPiece={mailPiece} onPaymentSuccess={onPaymentSuccess} onPaymentCancel={onPaymentCancel}/>
    </div>);
};
export default PaymentStep;
//# sourceMappingURL=PaymentStep.jsx.map