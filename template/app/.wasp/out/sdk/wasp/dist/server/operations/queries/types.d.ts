import { type _User, type _GptResponse, type _Task, type _File, type _MailAddress, type _DailyStats, type _MailPiece, type _MailPieceStatusHistory, type AuthenticatedQueryDefinition, type Payload } from 'wasp/server/_types';
...
export type GetMailAddressesByUser<Input extends Payload = never, Output extends Payload = Payload> = AuthenticatedQueryDefinition<[
    _User,
    _MailAddress
], Input, Output>;
...
export type GetMailPieces<Input extends Payload = never, Output extends Payload = Payload> = AuthenticatedQueryDefinition<[
    _MailPiece,
    _MailAddress,
    _File,
    _MailPieceStatusHistory
], Input, Output>;
export type GetMailPiece<Input extends Payload = never, Output extends Payload = Payload> = AuthenticatedQueryDefinition<[
    _MailPiece,
    _MailAddress,
    _File,
    _MailPieceStatusHistory
