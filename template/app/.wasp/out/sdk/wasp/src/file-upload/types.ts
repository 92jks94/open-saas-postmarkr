...
export interface ExtractPDFMetadataOutput {
  ...
  error?: string;
  [key: string]: string | number | boolean | null | undefined | PDFMetadata; // Index signature for Wasp Payload compatibility
}
...
export interface ValidatePDFFileOutput {
  ...
  error?: string;
  [key: string]: string | number | boolean | null | undefined | PDFValidationResult; // Index signature for Wasp Payload compatibility
}
