...
describe('Environment Validation', () => {
  ...
  it('should validate environment variables in production mode', () => {
    ...
    process.env.PAYMENTS_SMALL_BATCH_PLAN_ID = 'price_test_123';
    process.env.PAYMENTS_MEDIUM_BATCH_PLAN_ID = 'price_test_456';
    process.env.PAYMENTS_LARGE_BATCH_PLAN_ID = 'price_test_789';
