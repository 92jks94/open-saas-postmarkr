    ...
    <section className='py-24 relative overflow-hidden'>
      ...
      <div className='container mx-auto px-4'>
        <div className='text-center mb-16 animate-fade-in-up'>
          <h2 id='who-uses-heading' className='text-4xl md:text-5xl font-bold mb-4'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto'>
          {useCases.map((useCase, index) => {
            ...
            return (
              <Card
                key={index}
                className='p-6 bg-card/50 backdrop-blur border-border hover:border-primary/50 transition-all duration-300 hover:shadow-glass hover:-translate-y-1 group animate-fade-in-up'
