    ...
    <div className='bg-gray-50 dark:bg-gray-900'>
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        <footer
          ...
          className='border-t border-gray-200 dark:border-gray-700 py-16'
        >
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12'>
            ...
            <div className='lg:col-span-1'>
              <div className='flex items-center space-x-2 mb-4'>
                ...
                <span className='text-xl font-bold text-gray-900 dark:text-white'>Postmarkr</span>
              </div>
              <p className='text-sm text-gray-600 dark:text-gray-400 mb-4 max-w-xs'>
                Send physical mail digitally. Upload documents, add addresses, and we'll handle the rest.
              </p>
          ...
          <div className='mt-12 pt-8 border-t border-gray-200 dark:border-gray-700'>
            <div className='flex flex-col md:flex-row justify-between items-center'>
              <p className='text-sm text-gray-500 dark:text-gray-400'>
                © {currentYear} Postmarkr. All rights reserved.
              </p>
