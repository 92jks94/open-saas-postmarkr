...
const FileSelector: React.FC<FileSelectorProps> = ({
  ...
  const validateFileForMail = (file: File, mailType: string, mailSize: string): FileValidationResult => {
    // Import validation from file-upload module
    const { validateFileForMail: serverValidation } = require('../../file-upload/validation');
    
    // Use server-side validation logic
    const validation = serverValidation(file, mailType, mailSize);
    
    // Add additional client-side checks
